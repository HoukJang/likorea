...
exports.getSubCategoriesByParent = asyncHandler(async (req, res) => {
  ...
  const subCategories = await Tag.getSubCategoriesByParent(parentCategory);
...
exports.addTag = asyncHandler(async (req, res) => {
  const { category, value, displayName, order, description, parentCategory } = req.body;
...
exports.updateTag = asyncHandler(async (req, res) => {
  ...
  const { displayName, order, description, isActive, parentCategory } = req.body;
