    ...
    <div className="design-preview">
      <div className="preview-section">
        ...
        <div style={{ marginBottom: '40px' }}>
          ...
          <h3 style={{ marginBottom: '20px', color: '#374151', marginTop: '30px' }}>개선된 디자인 (새로운)</h3>
        ...
        <div className="description">
          <h3>🎯 주요 개선 사항</h3>
          <ul>
            <li><strong>색상 현대화:</strong> 빨간색 → 그린 계열로 변경하여 더 부드럽고 세련된 느낌</li>
            <li><strong>그라데이션 효과:</strong> 단색에서 그라데이션으로 변경하여 시각적 깊이감 추가</li>
            <li><strong>호버 효과 개선:</strong> 더 부드러운 애니메이션과 그림자 효과</li>
            <li><strong>일관성 향상:</strong> 모든 버튼이 동일한 디자인 언어 사용</li>
            <li><strong>접근성 개선:</strong> WCAG 2.1 AA 기준을 준수하는 색상 대비</li>
          </ul>
        </div>
        ...
        <div className="description" style={{ background: '#fef3c7', borderLeftColor: '#f59e0b' }}>
          ...
          <ul>
            <li><strong>글쓰기 버튼:</strong> 빨간색(#dc2626) → 그린 계열(#10b981)</li>
            <li><strong>Primary 버튼:</strong> 파란색(#2563eb) → 더 밝은 파란색(#3b82f6)</li>
            <li><strong>그림자 효과:</strong> 더 부드럽고 현대적인 그림자</li>
            <li><strong>애니메이션:</strong> 더 부드러운 cubic-bezier 곡선 사용</li>
          </ul>
        </div>
      </div>
    </div>
