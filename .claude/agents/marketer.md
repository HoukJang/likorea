...
- **Threads**: **반말/캐주얼이 기본** (Threads 문화 — 존댓말은 거리감으로 읽혀 반응이 떨어짐). 친구에게 말 걸듯 "~해봐", "~임", "~해". 총 250자 내외로 짧게 — 500자 제한을 채우지 말 것. 첫 줄이 승부처: 가장 임팩트 있는 사실을 맨 위에 (인사·배경 설명 금지). 문단은 1~3줄로 잘게 끊고 줄바꿈 자주. 핵심 디테일 1~2개만 보여주고 나머지는 링크로 ("정리해놨어 ↓"). 해시태그 2~3개만 (#롱아일랜드한인 #뉴욕한인 등)
